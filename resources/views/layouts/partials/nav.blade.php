                ...
                <div class="row g-0 align-items-center">
                    ...
                    <div class="col-8 text-center ">
                        <ul class="js-clone-nav d-none d-lg-inline-block text-start site-menu mx-auto">
                           ...
                           <li class="{{Route::is('prestations.*')?'active':''}}"><a href="{{route('prestations.index')}}">Prestations</a></li>
                            ...
                            @if(auth('admin')->check())
                                <li class="mx-2 border"><a  href="{{route('admin.home')}}"> <i class="fa fa-cogs"></i> Administration</a></li>
                            @else
                                @if (auth("web")->check())
                                    <li class="border rounded bg-success p-1"><a  href="{{route('dashboard')}}">Mon Dashboard</a></li>
                                @else
                    ...
                    <div class="col-2 text-end">
                        ...
                        <div class="btn-group btn-group-sm">
                            <a data-bs-target="#modalDon" data-bs-toggle="modal" class=" btn btn-success btn-sm rounded" href="{{route('donate')}}"><i class="fas fa-money-bill-wave"></i> Faire un don</a>
                        </div>
                    </div>
                </div>
            </div>
